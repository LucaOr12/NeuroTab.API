...
namespace neurotab_api.Migrations
{
    ...
    [Migration("20250710142748_ConnectionUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("neurotab_api.Models.Connection", b =>
                {
                    b.HasOne("neurotab_api.Models.Content", "FromContent")
                        .WithMany("OutGoingConnections")
                        .HasForeignKey("FromContentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("neurotab_api.Models.Content", "ToContent")
                        .WithMany("IncomingConnections")
                        .HasForeignKey("ToContentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FromContent");

                    b.Navigation("ToContent");
                });
